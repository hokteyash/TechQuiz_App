...
public class ViewAllScoresFrame extends javax.swing.JFrame {
    ...
    /**
     * Creates new form AllScoresFrame
     */
    ...
    private void initComponents() {
        ...
        jtAllData.setFont(new java.awt.Font("Comic Sans MS", 1, 14)); // NOI18N
    ...
    private void showAllData() {
        try{
            ...
            DefaultTableModel model = (DefaultTableModel)jtAllData.getModel();
            ...
            for(Performance p:performanceList){
                ...
                row[5] = p.getPercentage();
                row[6] = p.getLanguage();
                model.addRow(row);
            }
        }
        catch(SQLException ex){
            JOptionPane.showMessageDialog(null, "DB Error , In ViewAllScoresFrame","Error!",JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        }
    }
}
