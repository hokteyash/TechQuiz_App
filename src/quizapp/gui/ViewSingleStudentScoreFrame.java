...
public class ViewSingleStudentScoreFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/AllProjectIcons/SingleStudent.jpg"))); // NOI18N
        ...
        jcStudentId.setFont(new java.awt.Font("Comic Sans MS", 1, 24)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jcStudentId, 0, 180, Short.MAX_VALUE)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGap(114, 172, Short.MAX_VALUE)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
    ...
    private void jcExamIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcExamIdActionPerformed
       if(jcExamId.getItemCount()==0) return;
       String studentId = jcStudentId.getSelectedItem().toString();
       String subject = jcExamId.getSelectedItem().toString();
       try{
           StudentScore s = PerformanceDao.getScore(studentId, subject);
           txtLanguage.setText(s.getLanguage());
           txtPercentage.setText(String.valueOf(s.getPercentage()));
       }
       catch(SQLException ex){
            JOptionPane.showMessageDialog(null,"Error in DB , In ViewSingleStudentScoreFrame","Error",JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
